...
class Ui_Form(QWidget):
    def __init__(self, id, name, artist, img, link, parent_id):
        super().__init__()
        self.id=id
        self.name=name
        self.artist=artist
        self.img=img
        self.link=link
        self.parent_id = parent_id  # Khởi tạo parent_id
    ...
    def sendRemovePlaylist(self):
        client = Client()
        client.connect()
        receive = client.sendRemovePlayList("REMOVE_TO_PLAYLIST_" + self.parent_id + "_" + self.id)
        print(receive)
